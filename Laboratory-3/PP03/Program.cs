...
class Program
{
    static void Main(string[] args)
    {
        ...
        IFactory l1 = Lec03LibN.Lec03BLib.getL1(); // создаем новый объект типа класса salary1 (фабрика, есть рабочие)
        ...
        IFactory l2 = Lec03LibN.Lec03BLib.getL2(1);
        ...
        IFactory l3 = Lec03LibN.Lec03BLib.getL3(1.0f, 0.5f);
        ...
        Employee employee9 = new Employee(l3.getC(25, 1.06f, 2.85f));
